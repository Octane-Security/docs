...
description: 'Find out how your code stacks up to the EthTrust standard, and get actionable feedback on how to improve it.'
icon: ''
---
...
Luckily, there’s a new standard for smart contract security best practices, created by the some of the most respected security names in the space, including Quantstamp, OpenZeppelin, ConsenSys, Hacken, and more. It’s called (EthTrust)[https://entethalliance.github.io/eta-registry/security-levels-spec.html].
