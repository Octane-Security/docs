...
Octane will also provide a natural description (using the Attack Simulation Explanation Engine, ASEE) of how this attack occurred so that your team is able to effectively understand what caused the simulated attacker to self-destruct and/or profit from the self-destruction.
