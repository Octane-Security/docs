...
Octane will also provide a natural description (using the Attack Simulation Explanation Engine, ASEE) of how the attacker was able to violate the property, helping your team to more effectively understand what led to the property violation and how to fix it.
