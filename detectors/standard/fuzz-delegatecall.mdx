...
Octane will also provide a natural description (using the Attack Simulation Explanation Engine, ASEE) of how this attack occurred so that the team is able to effectively understand what caused the simulated attacker to delegatecall to their created malicious contract.
