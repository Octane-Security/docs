...
<Tip>
  If you’re having issues with GitHub authentication, reach out to [gio@octane.security](mailto:nathan@octane.security) to be added to the whitelist. Only approved accounts are able to access Octane.
</Tip>
...
<CardGroup cols="3">
  <Card title="Vulnerability Detectors" icon="stars" href="detectors/advanced">
    
  </Card>
  <Card title="Compliance Checks" icon="shield" href="compliance/advanced">
    
  </Card>
  <Card title="Attack Simulation" icon="bolt" href="attack-simulations/advanced">
