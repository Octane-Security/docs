...
- Compliance Checks
- Intelligent Fork Attack Simulations
...
Vulnerability Detectors typically complete after the first few minutes of analysis, while Intelligent Fork Attack Simulations run by default over 1 hour, but can be configured to run longer for even more thorough and niche analysis.
